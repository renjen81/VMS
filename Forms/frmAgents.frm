...
Begin VB.Form frmAgents 
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAgents.frx":0000
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmAgents.frx":2D92
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label2 
         ...
         Caption         =   "Agent/Consignee Records"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Image cmdExit 
         Height          =   360
         Left            =   9320
         MouseIcon       =   "frmAgents.frx":2EF4
         MousePointer    =   99  'Custom
         Picture         =   "frmAgents.frx":3046
         Stretch         =   -1  'True
         ToolTipText     =   "Close"
         Top             =   -27
         Width           =   360
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAgents.frx":3730
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmAgents.frx":54CA
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   2
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAgents.frx":562C
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmAgents.frx":73C6
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   3
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAgents.frx":7528
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmAgents.frx":92C2
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   4
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmAgents.frx":9424
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmAgents.frx":A17E
   End
...
rsData.Open "Select * from tblAgent", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = ListView1.ListItems.Add(, , rsData!AgentCode, 1, 1)
                    LS.SubItems(1) = rsData!AgentName
                    LS.SubItems(2) = rsData!Type
                    LS.SubItems(3) = rsData!AgentNos
                    LS.SubItems(4) = rsData!AgentAddress
                    LS.SubItems(5) = rsData!AgentContactPerson
                    LS.SubItems(6) = rsData!AgentPositions
...
Case "Edit"
            ...
            Set rsData = New ADODB.Recordset
            rsData.Open "Select * from tblAgent where AgentCode = '" & ListView1.SelectedItem.Text & "'", CN, adOpenStatic, adLockPessimistic
            If rsData.RecordCount < 1 Then Exit Sub
            With frmAgent
                .EditFlag = False
                .Text1.Text = rsData.Fields("AgentCode")
                .Text2.Text = rsData.Fields("AgentName")
                .Text3.Text = rsData.Fields("AgentNos")
                .Text4.Text = rsData.Fields("AgentAddress")
                .Text5.Text = rsData.Fields("AgentContactPerson")
                .Text6.Text = rsData.Fields("AgentPositions")
                ...
                .PK = srcRecord
                .cboType.Text = rsData.Fields("Type")
                .Show vbModal
            End With
            End If
...
Case "Delete"
           ...
           If ListView1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblAgent where AgentCode= '" & ListView1.SelectedItem.Text & "'")
            LoadEntries
