...
rsData.Open "Select * from tblBarangay", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = ListView1.ListItems.Add(, , rsData!BrgyCode, 1, 1)
                    LS.SubItems(1) = rsData!BrgyName
...
Case "Edit"
            ...
            rsData.Filter = "BrgyCode = '" & ListView1.SelectedItem.Text & "'"
            If rsData.RecordCount < 1 Then Exit Sub
            With frmCategory
              .EditFlag = False
              .Text1.Text = rsData.Fields("BrgyCode")
              .Text2.Text = rsData.Fields("BrgyName")
...
Case "Delete"
           ...
           If ListView1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblBarangay where BrgyCode= '" & ListView1.SelectedItem.Text & "'  ")
            LoadEntries
