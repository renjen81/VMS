...
Begin VB.Form frmCustomers 
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCustomers.frx":0000
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmCustomers.frx":2D92
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image cmdExit 
         Height          =   360
         Left            =   9320
         MouseIcon       =   "frmCustomers.frx":2EF4
         MousePointer    =   99  'Custom
         Picture         =   "frmCustomers.frx":3046
         Stretch         =   -1  'True
         ToolTipText     =   "Close"
         Top             =   -27
         Width           =   360
   ...
   Begin MSComctlLib.ListView ListView1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmCustomers.frx":3730
      NumItems        =   6
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCustomers.frx":3892
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmCustomers.frx":562C
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   2
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCustomers.frx":578E
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmCustomers.frx":7528
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   3
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCustomers.frx":768A
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmCustomers.frx":9424
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   4
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCustomers.frx":9586
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmCustomers.frx":A2E0
   End
...
rsData.Open "Select * from tblCustomer", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = ListView1.ListItems.Add(, , rsData!CustCode, 1, 1)
                    LS.SubItems(1) = rsData!CustName
                    LS.SubItems(2) = rsData!CustNos
                    LS.SubItems(3) = rsData!CustAddress
                    LS.SubItems(4) = rsData!CustEmail
                    LS.SubItems(5) = rsData!Remarks
...
Case "Edit"
            ...
            Set rsData = New ADODB.Recordset
            rsData.Open "Select * from tblCustomer where CustCode = '" & ListView1.SelectedItem.Text & "'", CN, adOpenStatic, adLockPessimistic
            If rsData.RecordCount < 1 Then Exit Sub
            With frmCustomer
                .EditFlag = False
                .Text1.Text = rsData.Fields("CustCode")
                .Text2.Text = rsData.Fields("CustName")
                .Text3.Text = rsData.Fields("CustNos")
                .Text4.Text = rsData.Fields("CustAddress")
                .Text5.Text = rsData.Fields("CustEmail")
...
Case "Delete"
           ...
           If ListView1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblCustomer where CustCode= '" & ListView1.SelectedItem.Text & "'")
            LoadEntries
