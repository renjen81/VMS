...
Begin VB.Form frmWarehouses 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image cmdExit 
         Height          =   360
         Left            =   9285
         MouseIcon       =   "frmWarehouses.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "frmWarehouses.frx":0152
         Stretch         =   -1  'True
         ToolTipText     =   "Close"
         Top             =   -27
         Width           =   360
   ...
   Begin MSComctlLib.ListView ListView1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmWarehouses.frx":083C
      NumItems        =   8
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmWarehouses.frx":099E
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmWarehouses.frx":3730
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   1
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmWarehouses.frx":3892
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmWarehouses.frx":562C
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   2
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmWarehouses.frx":578E
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmWarehouses.frx":7528
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   3
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmWarehouses.frx":768A
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmWarehouses.frx":9424
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   4
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmWarehouses.frx":9586
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmWarehouses.frx":A2E0
   End
   Begin MSComctlLib.ImageList ilRecordIco 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWarehouses.frx":A442
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmWarehouses"
...
rsData.Open "Select * from tblWarehouse", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = ListView1.ListItems.Add(, , rsData!WarCode, 1, 1)
                    LS.SubItems(1) = rsData!WarName
                    LS.SubItems(2) = rsData!WarAddress
                    LS.SubItems(3) = rsData!WarCoor
                    LS.SubItems(4) = rsData!BranchLoc
                    LS.SubItems(5) = rsData!BranchAdd
                    LS.SubItems(6) = rsData!BranchCoor
                    LS.SubItems(7) = rsData!Description
...
Case "Edit"
            ...
            rsData.Filter = "WarCode = '" & ListView1.SelectedItem.Text & "'"
            ...
            With frmWarehouse
              ...
              .Text4.Text = rsData.Fields("WarAddress")
              .Text5.Text = rsData.Fields("WarCoor")
              .Text6.Text = rsData.Fields("BranchLooc")
              .Text7.Text = rsData.Fields("BranchAdd")
              .Text8.Text = rsData.Fields("BranchCoor")
...
Case "Delete"
           ...
           If ListView1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblWarehouse where WarCode= '" & ListView1.SelectedItem.Text & "'  ")
            LoadEntries
