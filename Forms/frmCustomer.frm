...
With frmSuppliers.rsData
    If EditFlag = True Then .AddNew
        ...
        .Fields("CustNos") = Text3.Text
        .Fields("CustAddress") = Text4.Text
        .Fields("CustEmail") = Text5.Text
...
End With
    ...
    If EditFlag = True Then
        Call FindRec(frmCustomers.rsData, "CustCode", True, Text1.Text, 0)
...
Sub GeneratePK()
Dim iCode  As Long
    iCode = getIndex("tblCustomer")
    Text1.Text = GenerateID(iCode, "CUST-", "00000")
End Sub
...
If EditFlag = True Then frmCustomers.LoadEntries
