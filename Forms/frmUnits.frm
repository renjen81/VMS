...
Begin VB.Form frmUnits 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image cmdExit 
         Height          =   360
         Left            =   9285
         MouseIcon       =   "frmUnits.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "frmUnits.frx":0152
         Stretch         =   -1  'True
         ToolTipText     =   "Close"
         Top             =   -27
         Width           =   360
   ...
   Begin lvButton.lvButtons_H cmdButtons 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmUnits.frx":099E
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmUnits.frx":3730
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   1
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmUnits.frx":3892
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmUnits.frx":562C
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   2
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmUnits.frx":578E
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmUnits.frx":7528
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   3
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmUnits.frx":768A
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmUnits.frx":9424
   End
   Begin lvButton.lvButtons_H cmdButtons 
      Height          =   615
      Index           =   4
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmUnits.frx":9586
      ImgSize         =   32
      cBack           =   16119285
      mPointer        =   99
      mIcon           =   "frmUnits.frx":A2E0
   End
...
rsData.Open "Select * from tblPrecint", CN, adOpenStatic, adLockPessimistic
With rsData
    While Not .EOF
                Dim LS As ListItem
                Set LS = Listview1.ListItems.Add(, , rsData!PrecintCode, 1, 1)
                    LS.SubItems(1) = rsData!PrecintName
                    LS.SubItems(2) = rsData!Brgy
                    LS.SubItems(3) = rsData!Description
...
Case "Edit"
            ...
            rsData.Filter = "PrecintCode = '" & Listview1.SelectedItem.Text & "'"
            If rsData.RecordCount < 1 Then Exit Sub
            With frmUnit
              .EditFlag = False
              .Text1.Text = rsData.Fields("PrecintCode")
              .Text2.Text = rsData.Fields("PrecintName")
...
Case "Delete"
           ...
           If Listview1.ListItems.Count < 1 Then
            ...
            If wheng = vbYes Then
            CN.Execute ("Delete from  tblunit where PrecintCode= '" & Listview1.SelectedItem.Text & "'  ")
            LoadEntries
